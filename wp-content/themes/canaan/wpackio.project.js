...
module.exports = {
	// Project Identity
	appName: 'canaan', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'canaan', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				...
				main: ['./static/js/index.js'], // Or an array of string (string[])
			},
	...
	// appDir :'wp-content/themes/canaan',
	...
	watch: './wp-content/themes/canaan/**/*.php',
